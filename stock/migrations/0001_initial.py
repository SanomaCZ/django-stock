...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'stock_item', (
            ...
            ('pieces', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal(u'stock', ['Item'])

        # Adding model 'Operation'
        db.create_table(u'stock_operation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'stock', ['Operation'])


    def backwards(self, orm):
        # Deleting model 'Item'
        db.delete_table(u'stock_item')

        # Deleting model 'Operation'
        db.delete_table(u'stock_operation')
